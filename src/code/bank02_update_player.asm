...
; Details:
; Checks if player is in water or climbing.
...
data_02_554d_PlayerStatesPerAction:
    ...
    db   PLAYER_STATE_UNK04_MASK ; PLAYERACTION_TAKE_DAMAGE
    db   PLAYER_STATE_UNK01_MASK | PLAYER_STATE_UNK02_MASK | PLAYER_STATE_UNK04_MASK | PLAYER_STATE_DEAD_MASK ; PLAYERACTION_DEATH
    db   PLAYER_STATE_UNK01_MASK | PLAYER_STATE_UNK02_MASK | PLAYER_STATE_UNK04_MASK | PLAYER_STATE_DEAD_MASK ; PLAYERACTION_DEATH_SET_UP_WARP
    db   PLAYER_STATE_UNK01_MASK | PLAYER_STATE_UNK02_MASK | PLAYER_STATE_UNK04_MASK ; PLAYERACTION_STAND_ON_TV_BUTTON
    db   PLAYER_STATE_UNK01_MASK | PLAYER_STATE_UNK02_MASK | PLAYER_STATE_UNK04_MASK ; PLAYERACTION_ENTER_TV
    ...
    db   PLAYER_STATE_UNK04_MASK ; PLAYERACTION_LAND_FROM_FALL
    db   PLAYER_STATE_NONE_MASK ; PLAYERACTION_UNK19
    db   PLAYER_STATE_NONE_MASK ; PLAYERACTION_ENTER_IDLE
    db   PLAYER_STATE_UNK04_MASK ; PLAYERACTION_NONE_1
    db   PLAYER_STATE_UNK04_MASK ; PLAYERACTION_NONE_2
    db   PLAYER_STATE_UNK04_MASK ; PLAYERACTION_NONE_3
    db   PLAYER_STATE_UNK04_MASK ; PLAYERACTION_NONE_4
    db   PLAYER_STATE_IN_WATER_MASK ; PLAYERACTION_WATER_SWIMMING
    db   PLAYER_STATE_UNK01_MASK | PLAYER_STATE_UNK02_MASK | PLAYER_STATE_UNK04_MASK | PLAYER_STATE_DEAD_MASK ; PLAYERACTION_DEATH_IN_PIT_ALT
    db   PLAYER_STATE_UNK01_MASK | PLAYER_STATE_UNK02_MASK | PLAYER_STATE_UNK04_MASK | PLAYER_STATE_DEAD_MASK ; PLAYERACTION_DEATH_IN_PIT
    db   PLAYER_STATE_NONE_MASK ; PLAYERACTION_NONE_5
    db   PLAYER_STATE_NONE_MASK ; PLAYERACTION_BLOWN_UPWARDS
    db   PLAYER_STATE_UNK04_MASK ; PLAYERACTION_RIDING_ELEVATOR
    db   PLAYER_STATE_IN_WATER_MASK ; PLAYERACTION_WATER_TAIL_SPIN
    db   PLAYER_STATE_IN_WATER_MASK ; PLAYERACTION_WATER_TREADING
    db   PLAYER_STATE_UNK04_MASK | PLAYER_STATE_IN_WATER_MASK ; PLAYERACTION_WATER_DIVING
    ...
    db   PLAYER_STATE_UNK04_MASK ; PLAYERACTION_SNOWBOARDING_TAKE_DAMAGE
    db   PLAYER_STATE_UNK01_MASK | PLAYER_STATE_UNK02_MASK | PLAYER_STATE_UNK04_MASK | PLAYER_STATE_DEAD_MASK ; PLAYERACTION_SNOWBOARDING_DIE
    db   PLAYER_STATE_UNK01_MASK | PLAYER_STATE_UNK02_MASK | PLAYER_STATE_UNK04_MASK | PLAYER_STATE_DEAD_MASK ; PLAYERACTION_SNOWBOARDING_DIE_WARP
    db   PLAYER_STATE_UNK01_MASK | PLAYER_STATE_UNK02_MASK | PLAYER_STATE_UNK04_MASK ; PLAYERACTION_SNOWBOARDING_STAND_ON_TV_BUTTON
    db   PLAYER_STATE_UNK01_MASK | PLAYER_STATE_UNK02_MASK | PLAYER_STATE_UNK04_MASK ; PLAYERACTION_SNOWBOARDING_ENTER_TV
    db   PLAYER_STATE_UNK01_MASK | PLAYER_STATE_UNK02_MASK | PLAYER_STATE_UNK04_MASK | PLAYER_STATE_DEAD_MASK ; PLAYERACTION_SNOWBOARDING_DEATH_IN_PIT_ALT
    ...
    db   PLAYER_STATE_UNK04_MASK ; PLAYERACTION_KANGAROO_TAKE_DAMAGE
    db   PLAYER_STATE_UNK01_MASK | PLAYER_STATE_UNK02_MASK | PLAYER_STATE_UNK04_MASK | PLAYER_STATE_DEAD_MASK ; PLAYERACTION_KANGAROO_DEATH
    db   PLAYER_STATE_UNK01_MASK | PLAYER_STATE_UNK02_MASK | PLAYER_STATE_UNK04_MASK | PLAYER_STATE_DEAD_MASK ; PLAYERACTION_KANGAROO_DEATH_SET_UP_WARP
    db   PLAYER_STATE_UNK01_MASK | PLAYER_STATE_UNK02_MASK | PLAYER_STATE_UNK04_MASK ; PLAYERACTION_KANGAROO_STAND_ON_TV_BUTTON
    db   PLAYER_STATE_UNK01_MASK | PLAYER_STATE_UNK02_MASK | PLAYER_STATE_UNK04_MASK ; PLAYERACTION_KANGAROO_ENTER_TV
    db   PLAYER_STATE_UNK01_MASK | PLAYER_STATE_UNK02_MASK | PLAYER_STATE_UNK04_MASK | PLAYER_STATE_DEAD_MASK ; PLAYERACTION_KANGAROO_DEATH_IN_PIT_ALT
    db   PLAYER_STATE_NONE_MASK ; PLAYERACTION_SPAWN
    db   PLAYER_STATE_NONE_MASK ; PLAYERACTION_IDLE
    db   PLAYER_STATE_NONE_MASK ; PLAYERACTION_IDLE_ANIMATION
    db   PLAYER_STATE_NONE_MASK ; PLAYERACTION_WALK
