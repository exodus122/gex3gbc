...
; Why: Handles incremental background updates only where scrolling occurred.
    ...
    call NZ, call_00_11e5_BgMap_LoadVerticalStrip                              ;; 00:11d4 $c4 $e5 $11
    ld   A, [wDC20_BgMapLoadingFlags]                                    ;; 00:11d7 $fa $20 $dc
    and  A, $0c                                        ;; 00:11da $e6 $0c
    call NZ, call_00_1351_BgMap_LoadHorizontalStrip                              ;; 00:11dc $c4 $51 $13
    ld   HL, wDC20_BgMapLoadingFlags                                     ;; 00:11df $21 $20 $dc
    set  7, [HL]                                       ;; 00:11e2 $cb $fe
    ret                                                ;; 00:11e4 $c9

call_00_11e5_BgMap_LoadVerticalStrip:
...
call_00_1351_BgMap_LoadHorizontalStrip:
