...
; Others may map to more cases.
    db   $00 ; ENTITY_GEX
    db   PLAYER_CAN_TOUCH_ENTITY | PLAYER_CAN_ATTACK_ENTITY ; ENTITY_BONUS_COIN
    db   PLAYER_CAN_TOUCH_ENTITY | PLAYER_CAN_ATTACK_ENTITY ; ENTITY_FLY_COIN_SPAWN
    db   PLAYER_CAN_TOUCH_ENTITY | PLAYER_CAN_ATTACK_ENTITY ; ENTITY_PAW_COIN
    db   PLAYER_CAN_TOUCH_ENTITY | PLAYER_CAN_ATTACK_ENTITY ; ENTITY_FLY_1
    db   PLAYER_CAN_TOUCH_ENTITY | PLAYER_CAN_ATTACK_ENTITY ; ENTITY_FLY_2
    db   PLAYER_CAN_TOUCH_ENTITY | PLAYER_CAN_ATTACK_ENTITY ; ENTITY_FLY_3
    db   PLAYER_CAN_TOUCH_ENTITY | PLAYER_CAN_ATTACK_ENTITY ; ENTITY_FLY_4
    db   PLAYER_CAN_TOUCH_ENTITY | PLAYER_CAN_ATTACK_ENTITY ; ENTITY_FLY_5
    db   PLAYER_CAN_ATTACK_ENTITY ; ENTITY_GREEN_FLY_TV
    db   PLAYER_CAN_ATTACK_ENTITY ; ENTITY_PURPLE_FLY_TV
    db   PLAYER_CAN_ATTACK_ENTITY ; ENTITY_UNK_FLY_TV_3
    db   PLAYER_CAN_ATTACK_ENTITY ; ENTITY_BLUE_FLY_TV
    db   PLAYER_CAN_ATTACK_ENTITY ; ENTITY_UNK_FLY_TV_5
    db   $00 ; ENTITY_UNK0E
    db   $00 ; ENTITY_UNK0F
    db   $00 ; ENTITY_UNK10
    db   PLAYER_CAN_TOUCH_ENTITY ; ENTITY_TV_BUTTON
    ...
    db   PLAYER_CAN_ATTACK_ENTITY ; ENTITY_FREESTANDING_REMOTE
    db   PLAYER_CAN_ATTACK_ENTITY ; ENTITY_HOLIDAY_TV_ICE_SCULPTURE
    db   PLAYER_CAN_TOUCH_ENTITY ; ENTITY_HOLIDAY_TV_EVIL_SANTA
    db   PLAYER_CAN_TOUCH_ENTITY | PLAYER_CAN_ATTACK_ENTITY ; ENTITY_HOLIDAY_TV_EVIL_SANTA_PROJECTILE
    db   PLAYER_CAN_TOUCH_ENTITY | PLAYER_CAN_ATTACK_ENTITY ; ENTITY_HOLIDAY_TV_SKATING_ELF
    db   PLAYER_CAN_TOUCH_ENTITY | PLAYER_CAN_ATTACK_ENTITY | PLAYER_CAN_STOMP_ENTITY ; ENTITY_HOLIDAY_TV_PENGUIN
    db   PLAYER_CAN_TOUCH_ENTITY | PLAYER_CAN_ATTACK_ENTITY | PLAYER_CAN_STOMP_ENTITY ; ENTITY_MYSTERY_TV_REZLING
    db   PLAYER_CAN_ATTACK_ENTITY ; ENTITY_MYSTERY_TV_BLOOD_COOLER
    db   PLAYER_CAN_TOUCH_ENTITY ; ENTITY_MYSTERY_TV_FISH
    db   PLAYER_CAN_TOUCH_ENTITY | PLAYER_CAN_ATTACK_ENTITY ; ENTITY_MYSTERY_TV_MAGIC_SWORD
    db   PLAYER_CAN_TOUCH_ENTITY | PLAYER_CAN_ATTACK_ENTITY ; ENTITY_MYSTERY_TV_SAFARI_SAM
    db   PLAYER_CAN_TOUCH_ENTITY ; ENTITY_MYSTERY_TV_SAFARI_SAM_PROJECTILE
    db   PLAYER_CAN_TOUCH_ENTITY | PLAYER_CAN_ATTACK_ENTITY ; ENTITY_MYSTERY_TV_GHOST_KNIGHT
    db   PLAYER_CAN_TOUCH_ENTITY ; ENTITY_MYSTERY_TV_GHOST_KNIGHT_PROJECTILE
    db   PLAYER_CAN_TOUCH_ENTITY | PLAYER_CAN_ATTACK_ENTITY ; ENTITY_TUT_TV_HAND
    db   PLAYER_CAN_STOMP_ENTITY ; ENTITY_TUT_TV_LOST_ARK
    db   $00 ; ENTITY_TUT_TV_RISING_PLATFORM
    db   $00 ; ENTITY_TUT_TV_SIDEWAYS_PLATFORM
    db   PLAYER_CAN_TOUCH_ENTITY | PLAYER_CAN_ATTACK_ENTITY ; ENTITY_TUT_TV_BEE
    db   $00 ; ENTITY_TUT_TV_RAFT
    db   PLAYER_CAN_TOUCH_ENTITY | PLAYER_CAN_STOMP_ENTITY ; ENTITY_TUT_TV_SNAKE_FACING_RIGHT
    db   PLAYER_CAN_TOUCH_ENTITY | PLAYER_CAN_STOMP_ENTITY ; ENTITY_TUT_TV_SNAKE_FACING_LEFT
    db   PLAYER_CAN_TOUCH_ENTITY ; ENTITY_TUT_TV_SNAKE_RIGHT_PROJECTILE
    db   PLAYER_CAN_TOUCH_ENTITY ; ENTITY_TUT_TV_SNAKE_LEFT_PROJECTILE
    db   PLAYER_CAN_ATTACK_ENTITY ; ENTITY_TUT_TV_RA_STAFF
    db   PLAYER_CAN_TOUCH_ENTITY ; ENTITY_TUT_TV_RA_STATUE_HORIZONTAL_PROJECTILE
    db   PLAYER_CAN_TOUCH_ENTITY ; ENTITY_TUT_TV_RA_STATUE_DIAGONAL_PROJECTILE
    db   $00 ; ENTITY_TUT_TV_BREAKABLE_BLOCK
    db   PLAYER_CAN_ATTACK_ENTITY ; ENTITY_TUT_TV_COFFIN
    db   PLAYER_CAN_TOUCH_ENTITY | PLAYER_CAN_ATTACK_ENTITY ; ENTITY_WESTERN_STATION_ENEMY_CACTUS
    db   PLAYER_CAN_TOUCH_ENTITY ; ENTITY_WESTERN_STATION_CACTUS
    db   $00 ; ENTITY_WESTERN_STATION_ROCK_PLATFORM
    db   PLAYER_CAN_TOUCH_ENTITY | PLAYER_CAN_ATTACK_ENTITY ; ENTITY_WESTERN_STATION_HARD_HAT
    db   $06 ; ENTITY_WESTERN_STATION_PLAYING_CARD
    db   PLAYER_CAN_TOUCH_ENTITY | PLAYER_CAN_ATTACK_ENTITY ; ENTITY_WESTERN_STATION_BAT
    db   $00 ; ENTITY_WESTERN_STATION_RISING_PLATFORM
    db   PLAYER_CAN_TOUCH_ENTITY ; ENTITY_ANIME_CHANNEL_DOOR
    db   PLAYER_CAN_TOUCH_ENTITY ; ENTITY_ANIME_CHANNEL_DOOR2
    db   $00 ; ENTITY_ANIME_CHANNEL_FAN_LIFT
    db   PLAYER_CAN_TOUCH_ENTITY | PLAYER_CAN_ATTACK_ENTITY ; ENTITY_ANIME_CHANNEL_MECH_FACING_RIGHT
    db   PLAYER_CAN_TOUCH_ENTITY | PLAYER_CAN_ATTACK_ENTITY ; ENTITY_ANIME_CHANNEL_MECH_FACING_LEFT
    db   $00 ; ENTITY_ANIME_CHANNEL_DISAPPEARING_FLOOR
    db   PLAYER_CAN_ATTACK_ENTITY ; ENTITY_ANIME_CHANNEL_ON_SWITCH2
    db   PLAYER_CAN_ATTACK_ENTITY ; ENTITY_ANIME_CHANNEL_ALIEN_CULTURE_TUBE
    db   PLAYER_CAN_TOUCH_ENTITY ; ENTITY_ANIME_CHANNEL_BLUE_BEAM_BARRIER
    db   $00 ; ENTITY_ANIME_CHANNEL_RISING_PLATFORM
    db   PLAYER_CAN_ATTACK_ENTITY ; ENTITY_ANIME_CHANNEL_ON_SWITCH
    db   PLAYER_CAN_ATTACK_ENTITY ; ENTITY_ANIME_CHANNEL_OFF_SWITCH
    db   PLAYER_CAN_TOUCH_ENTITY | PLAYER_CAN_ATTACK_ENTITY ; ENTITY_ANIME_CHANNEL_SAILOR_TOON_GIRL
    db   PLAYER_CAN_TOUCH_ENTITY | PLAYER_CAN_ATTACK_ENTITY ; ENTITY_ANIME_CHANNEL_BIG_SILVER_ROBOT
    db   PLAYER_CAN_TOUCH_ENTITY | PLAYER_CAN_STOMP_ENTITY ; ENTITY_ANIME_CHANNEL_SMALL_BLUE_ROBOT
    db   PLAYER_CAN_TOUCH_ENTITY | PLAYER_CAN_ATTACK_ENTITY ; ENTITY_ANIME_CHANNEL_SECBOT
    db   PLAYER_CAN_TOUCH_ENTITY ; ENTITY_ANIME_CHANNEL_SECBOT_PROJECTILE
    db   $00 ; ENTITY_ANIME_CHANNEL_ELEVATOR
    db   $00 ; ENTITY_ANIME_CHANNEL_FIRE_WALL_ENEMY
    db   PLAYER_CAN_TOUCH_ENTITY ; ENTITY_ANIME_CHANNEL_GRENADE
    db   PLAYER_CAN_STOMP_ENTITY ; ENTITY_ANIME_CHANNEL_PLANET_O_BLAST_WEAPON
    db   $00 ; ENTITY_SUPERHERO_SHOW_MAD_BOMBER
    db   PLAYER_CAN_TOUCH_ENTITY | PLAYER_CAN_ATTACK_ENTITY ; ENTITY_SUPERHERO_SHOW_BOMB
    db   $00 ; ENTITY_SUPERHERO_SHOW_WATER_TOWER_TANK
    db   PLAYER_CAN_TOUCH_ENTITY | PLAYER_CAN_ATTACK_ENTITY ; ENTITY_SUPERHERO_SHOW_WATER_TOWER_STAND
    db   PLAYER_CAN_TOUCH_ENTITY | PLAYER_CAN_ATTACK_ENTITY ; ENTITY_SUPERHERO_SHOW_CONVICT
    db   PLAYER_CAN_TOUCH_ENTITY | PLAYER_CAN_ATTACK_ENTITY ; ENTITY_SUPERHERO_SHOW_SPIDER
    db   PLAYER_CAN_TOUCH_ENTITY | PLAYER_CAN_ATTACK_ENTITY | PLAYER_CAN_STOMP_ENTITY ; ENTITY_SUPERHERO_SHOW_STRAY_CAT
    db   PLAYER_CAN_TOUCH_ENTITY | PLAYER_CAN_ATTACK_ENTITY ; ENTITY_SUPERHERO_SHOW_YELLOW_GOON
    db   PLAYER_CAN_TOUCH_ENTITY | PLAYER_CAN_ATTACK_ENTITY ; ENTITY_SUPERHERO_SHOW_RAT
    db   PLAYER_CAN_TOUCH_ENTITY | PLAYER_CAN_ATTACK_ENTITY ; ENTITY_SUPERHERO_SHOW_CHOMPER_TV
    db   $00 ; ENTITY_SUPERHERO_SHOW_CRUMBLING_FLOOR
    db   PLAYER_CAN_TOUCH_ENTITY ; ENTITY_SUPERHERO_SHOW_CONVICT_PROJECTILE
    db   PLAYER_CAN_TOUCH_ENTITY | PLAYER_CAN_ATTACK_ENTITY ; ENTITY_GEXTREME_SPORTS_ELF
    db   PLAYER_CAN_ATTACK_ENTITY ; ENTITY_GEXTREME_SPORTS_BONUS_TIME_COIN
    db   PLAYER_CAN_ATTACK_ENTITY ; ENTITY_MARSUPIAL_MADNESS_BELL
    db   PLAYER_CAN_TOUCH_ENTITY ; ENTITY_MARSUPIAL_MADNESS_BIRD
    db   PLAYER_CAN_TOUCH_ENTITY ; ENTITY_MARSUPIAL_MADNESS_BIRD_PROJECTILE
    db   PLAYER_CAN_TOUCH_ENTITY | PLAYER_CAN_ATTACK_ENTITY ; ENTITY_WW_GEX_WRESTLING_ROCK_HARD
    db   PLAYER_CAN_TOUCH_ENTITY ; ENTITY_LIZARD_OF_OZ_BRAIN_OF_OZ
    db   $00 ; ENTITY_LIZARD_OF_OZ_CANNON_PROJECTILE
    db   PLAYER_CAN_ATTACK_ENTITY ; ENTITY_LIZARD_OF_OZ_CANNON
    db   PLAYER_CAN_TOUCH_ENTITY ; ENTITY_LIZARD_OF_OZ_BRAIN_OF_OZ_PROJECTILE
    ...
    db   PLAYER_CAN_TOUCH_ENTITY ; ENTITY_CHANNEL_Z_BLUE_BEAM_BARRIER
    db   PLAYER_CAN_TOUCH_ENTITY ; ENTITY_CHANNEL_Z_METEOR
    db   PLAYER_CAN_TOUCH_ENTITY ; ENTITY_CHANNEL_Z_REZ_PROJECTILE
