...
; alternating MENU_COUNTER_* and $4a63
; ------------------------------------------------------------------
...
data_01_580a_MenuScript_Unk10:
    menu_cmd_sub $00,             $00,             $00, $00, MENUCMD_SUB_FULLSCREEN_IMAGE,   MENU_IMAGE_UNK10,                     MENUCMD_OPTION_NONE, MENUCMD_FLAG_NO_TILE_FILL | MENUCMD_FLAG_UPLOAD_TILES
