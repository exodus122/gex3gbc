...
; Special flags (wDCD2_FreestandingRemoteHitFlags, wDC88_CurrentObject_UnkVerticalOffset) are level or event triggers.
...
;       A = 0 → Player takes damage from object
;       A = 1 → Player damaged the object (with tail spin)
