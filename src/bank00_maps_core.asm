...
; banks to copy in the proper level/map data (entry_03_6c89_LoadMapData, entry_03_6203_LoadLevelBoundariesFromId, etc.).
...
; or changing areas while preserving player state.
    ...
    ld   HL, entry_03_6c89_LoadMapData                              ;; 00:1ef2 $21 $89 $6c
...
.jp_00_1f9f:
    ...
    ld   HL, entry_03_6c89_LoadMapData                              ;; 00:1fb9 $21 $89 $6c
