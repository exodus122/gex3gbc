    ...
    db   OBJECT_TUT_TV_SNAKE_FACING_RIGHT
    dw   $0080, $0110
    ...
    db   OBJECT_TUT_TV_SNAKE_FACING_LEFT
    dw   $01a0, $00f0
    ...
    db   OBJECT_TUT_TV_RISING_PLATFORM
    dw   $0620, $00f8
    ...
    db   OBJECT_TUT_TV_SIDEWAYS_PLATFORM
    dw   $0170, $0180
    ...
    db   OBJECT_TUT_TV_RA_STATUE_HORIZONTAL_PROJECTILE
    dw   $0174, $0026
    dw   $0200, $0180, $0036, $0016
    dw   $0000
    db   $20

    db   OBJECT_TUT_TV_RA_STATUE_DIAGONAL_PROJECTILE
    dw   $020c, $0026
    dw   $0200, $0180, $0036, $0016
    dw   $0001
    db   $20
    ...
    db   OBJECT_TUT_TV_HAND
    dw   $01a0, $0048
    dw   $01e0, $0180, $0058, $0038
    dw   $0000
    db   $1b

    db   OBJECT_TUT_TV_BREAKABLE_BLOCK
    dw   $01b0, $0058
    dw   $01c0, $01a0, $0068, $0048
    dw   $0000
    db   $1b

    db   OBJECT_TUT_TV_RAFT
    dw   $0070, $0158
    dw   $0600, $0030, $0168, $0148
    dw   $0000
    db   $1c

    db   OBJECT_TUT_TV_BEE
    dw   $0210, $0120
