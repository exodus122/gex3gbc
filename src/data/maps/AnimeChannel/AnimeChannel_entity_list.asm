    ...
    db   ENTITY_BONUS_COIN
    dw   $0180, $0040
    dw   $0190, $0170, $0050, $0030
    dw   $0000
    db   $29

    db   ENTITY_ANIME_CHANNEL_DOOR
    dw   $00c0, $01c0
    ...
    db   ENTITY_ANIME_CHANNEL_SMALL_BLUE_ROBOT
    dw   $0048, $00a8
    ...
    db   ENTITY_ANIME_CHANNEL_SAILOR_TOON_GIRL
    dw   $0b80, $0080
    dw   $0bc0, $0b40, $0090, $0070
    dw   $0000
    db   $2c

    db   ENTITY_ANIME_CHANNEL_BLUE_BEAM_BARRIER
    dw   $0ca8, $0050
    dw   $0cb8, $0c98, $0080, $0030
    dw   $0000
    db   $2c

    db   ENTITY_ANIME_CHANNEL_GRENADE
    dw   $0cf0, $0088
    ...
    db   ENTITY_ANIME_CHANNEL_OFF_SWITCH
    dw   $0d28, $0038
    ...
    db   ENTITY_ANIME_CHANNEL_ON_SWITCH
    dw   $0eb8, $0148
    dw   $0ec8, $0ea8, $0158, $0138
    dw   $0001
    db   $2c

    db   ENTITY_ANIME_CHANNEL_FAN_LIFT
    dw   $0ef0, $0138
    ...
    db   ENTITY_ANIME_CHANNEL_BIG_SILVER_ROBOT
    dw   $0b20, $0138
    ...
    db   ENTITY_ANIME_CHANNEL_RISING_PLATFORM
    dw   $07c8, $0140
    ...
    db   ENTITY_ANIME_CHANNEL_MECH_FACING_RIGHT
    dw   $0160, $0110
    ...
    db   ENTITY_ANIME_CHANNEL_ALIEN_CULTURE_TUBE
    dw   $0050, $00e0
    dw   $0060, $0040, $00f0, $00d0
    dw   $000b
    db   $2d

    db   ENTITY_PURPLE_FLY_TV
    dw   $0030, $0040
    ...
    db   ENTITY_ANIME_CHANNEL_ELEVATOR
    dw   $01a0, $0298
    ...
    db   ENTITY_ANIME_CHANNEL_ON_SWITCH2
    dw   $0358, $0248
    ...
    db   ENTITY_ANIME_CHANNEL_PLANET_O_BLAST_WEAPON
    dw   $05a8, $0080
    dw   $05b8, $0598, $0090, $0070
    dw   $0008
    db   $2b

    db   ENTITY_ANIME_CHANNEL_FIRE_WALL_ENEMY
    dw   $0158, $0198
    ...
    db   ENTITY_ANIME_CHANNEL_SECBOT
    dw   $01d0, $01c8
    ...
    db   ENTITY_ANIME_CHANNEL_MECH_FACING_LEFT
    dw   $02a0, $0050
    ...
    db   ENTITY_ANIME_CHANNEL_DISAPPEARING_FLOOR
    dw   $00e0, $0098
