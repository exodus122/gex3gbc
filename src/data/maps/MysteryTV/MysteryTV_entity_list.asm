    ...
    db   ENTITY_MYSTERY_TV_BLOOD_COOLER
    dw   $01ec, $0018
    ...
    db   ENTITY_MYSTERY_TV_MAGIC_SWORD
    dw   $0068, $0038
    dw   $0078, $0058, $0048, $0028
    dw   $0000
    db   $18

    db   ENTITY_MYSTERY_TV_REZLING
    dw   $0090, $02b0
    ...
    db   ENTITY_MYSTERY_TV_SAFARI_SAM
    dw   $0210, $01d0
    ...
    db   ENTITY_MYSTERY_TV_GHOST_KNIGHT
    dw   $0058, $0013
