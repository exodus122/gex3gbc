...
;
; Rendered from data/maps/SuperheroShow/SuperheroShow_spawns.bin
...
; ==================================================================
    ...
    db   MAP_SUPERHERO_SHOW2                   ; #$00
    dw   $0bc0, $02a0
    db   MAP_SPAWN_LINK_ABSOLUTE, $00, $00

    db   MAP_SUPERHERO_SHOW1                   ; #$01
    dw   $0070, $00b0
    db   MAP_SPAWN_LINK_ABSOLUTE, $00, $00

    db   MAP_SUPERHERO_SHOW3                   ; #$02
    dw   $0060, $0080
    db   MAP_SPAWN_LINK_ABSOLUTE, $00, $00

    db   MAP_SUPERHERO_SHOW1                   ; #$03
    dw   $0070, $0100
    db   MAP_SPAWN_LINK_ABSOLUTE, $00, $00

    db   MAP_SUPERHERO_SHOW4                   ; #$04
    dw   $00e0, $01a0
    db   MAP_SPAWN_LINK_ABSOLUTE, $00, $00

    db   MAP_SUPERHERO_SHOW2                   ; #$05
    dw   $0080, $0320
    db   MAP_SPAWN_LINK_ABSOLUTE, $00, $00

    db   MAP_SUPERHERO_SHOW5                   ; #$06
    dw   $02a0, $01c0
    db   MAP_SPAWN_LINK_ABSOLUTE, $00, $00

    db   MAP_SUPERHERO_SHOW2                   ; #$07
    dw   $0440, $0100
    db   MAP_SPAWN_LINK_ABSOLUTE, $00, $00

    db   MAP_SUPERHERO_SHOW6                   ; #$08
    dw   $0050, $0060
    db   MAP_SPAWN_LINK_ABSOLUTE, $00, $00

    db   MAP_SUPERHERO_SHOW5                   ; #$09
    dw   $02a0, $0080
    db   MAP_SPAWN_LINK_ABSOLUTE, $00, $00
