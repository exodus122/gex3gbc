...
;
; Rendered from data/maps/GextremeSports/GextremeSports_spawns.bin
...
; ==================================================================
    ...
    db   MAP_GEXTREME_SPORTS2                  ; #$00
    dw   $0020, $0130
    db   MAP_SPAWN_LINK_ABSOLUTE, $00, $00

    db   MAP_GEXTREME_SPORTS3                  ; #$01
    dw   $0020, $0130
    db   MAP_SPAWN_LINK_ABSOLUTE, $00, $00

    db   MAP_GEXTREME_SPORTS4                  ; #$02
    dw   $0020, $0130
    db   MAP_SPAWN_LINK_ABSOLUTE, $00, $00

    db   MAP_GEXTREME_SPORTS1                  ; #$03
    dw   $027c, $02b8
    db   MAP_SPAWN_LINK_ABSOLUTE, $00, $00

    db   MAP_GEXTREME_SPORTS1                  ; #$04
    dw   $01fc, $01b8
    db   MAP_SPAWN_LINK_ABSOLUTE, $00, $00

    db   MAP_GEXTREME_SPORTS1                  ; #$05
    dw   $018c, $00f8
    db   MAP_SPAWN_LINK_ABSOLUTE, $00, $00
