    ...
    db   Object_WesternStation_Cactus
    dw   $00f0, $0148
    ...
    db   Object_WesternStation_PlayingCard
    dw   $0260, $0020
    dw   $0270, $0250, $0030, $0010
    dw   $0000
    db   $04

    db   Object_WesternStation_HardHat
    dw   $0028, $0108
    ...
    db   Object_WesternStation_RockPlatform
    dw   $005e, $0150
    ...
    db   Object_TutTV_SnakeFacingRight
    dw   $0014, $0065
    ...
    db   Object_WesternStation_RisingPlatform
    dw   $0768, $00b8
